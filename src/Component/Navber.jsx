...
const Navber = () => {
	...
	<div className="container flex justify-between h-16 mx-auto">
		...
		<div className="items-center flex-shrink-0 hidden lg:flex gap-4">
			<NavLink to="/signin" className="self-center px-8 py-3 rounded btn btn-accent">Sign in</NavLink>
			<NavLink to="/signup" className="self-center px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50  btn btn-accent ">Sign up</NavLink>
		</div>
