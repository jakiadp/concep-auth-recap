...
const Blog = () => {
    return (
        <div className='w-11/12 mx-auto mt-10 '>
            <div className="relative flex flex-col max-w-2xl p-6 divide-y xl:flex-row xl:divide-y-0 xl:divide-x bg-gray-50 dark:text-gray-800 divide-gray-300 mx-auto mt-10">
